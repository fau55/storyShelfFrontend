  ...
  complete() {
    return __async(this, null, function* () {
      ...
      for (const t2 of this.queries)
        yield gu(this.localStore, t2, e.get(t2.name));
    ...
    return __async(this, null, function* () {
      try {
        ...
        if (yield function(t3, e3) {
          ...
          return yield e2.close(), n2._completeWith(function(t3) {
            return {
              taskState: "Success",
  ...
  return __async(this, null, function* () {
    if (!t._offlineComponents)
      if (t._uninitializedComponentsProvider) {
        ...
        N2("FirestoreClient", "Using default OfflineComponentProvider"), yield Na2(t, new Ea());
...
function snapToData(snapshot, options) {
  ...
  return __assign(__assign({}, data), (_a2 = {}, _a2[options.idField] = snapshot.id, _a2));
}
...
var filterEmptyUnlessFirst = function() {
  return pipe(windowwise(), filter(function(_a2) {
    var prior = _a2[0], current = _a2[1];
...
function collectionChanges(query2, options) {
  ...
  return fromRef(query2, { includeMetadataChanges: true }).pipe(windowwise(), map(function(_a2) {
    var priorSnapshot = _a2[0], currentSnapshot = _a2[1];
...
function collection(query2) {
  return fromRef(query2, { includeMetadataChanges: true }).pipe(map(function(changes) {
    return changes.docs;
  }));
}
...
var setLogLevel = ɵzoneWrap(x2, true);
